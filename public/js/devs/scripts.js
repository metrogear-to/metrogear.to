...
const changeDev = (name) => {
    switch (name) {
        case 'alexg':
            ...
            profileBlurb.textContent = "I'm a 2nd year university student in Mechatronics Engineering at the University of Waterloo. I live in Toronto, Ontario and have a keen passion for sports, fashion, and technology."
        ...
        case 'alexh':
            ...
            profileBlurb.textContent = "I'm a 2nd year university student in Mechatronics Engineering at the University of Waterloo. I live in (^_^)WHITBY(^_^), Ontario and have a keen passion for sports, fashion, and technology."
            ...
            website.href = ''
            resume.href = '../img/devs/alexh/alexHeResume.pdf'
            break;
        case 'araf':
            profilePicture.src = '../img/devs/araf/araf.jpeg'
            profileName.textContent = 'Araf Khan'
            profileBlurb.textContent = "I'm a 2nd year university student in Chemical Engineering at the University of Waterloo. I live in Toronto, Ontario and have a keen passion for sports, fashion, and technology."
        ...
        case 'arvin':
            ...
            profileBlurb.textContent = "I'm a 2nd year university student in Civil Engineering at York University. I live in Toronto, Ontario and have a keen passion for sports, fashion, and technology."
        ...
        case 'saihan':
            ...
            profileBlurb.textContent = "I'm a 2nd year university student in Business Commerce at Ryerson University. I live in Toronto, Ontario and have a keen passion for sports, fashion, and technology."
